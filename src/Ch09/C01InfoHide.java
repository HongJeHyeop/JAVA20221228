...
// protected		: 동일 패키지에 속한 클래스 or 상속관계에서의 하위 클래스에서만 접근가능
...
class C01Person {
	...
	// 나머지 private 멤버를 getter and setter함수로 완성해봅니다. (id는 getter만 만드세요)
...
public class C01InfoHide {
	public static void main(String[] args) {
		C01Person obj = new C01Person("홍길동", "0000000-11111111", 40, 80.5f, 177.5, 8000);
